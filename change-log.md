...
- **Os desejos ficam por ordem de quando acontecem:** cada um diz a data da próxima edição, assim que o organizador a publica e a recolha a traz, ou o mês em que a prova costuma ser enquanto não há data, e a lista segue essa ordem em vez do alfabeto.
