...
- **Los parkruns salen del calendario de pruebas anuales:** se leían de los calendarios alemanes como pruebas con fecha e inscripción, junto al mismo lugar en el catálogo de parkrun de la app. Las pruebas anuales con «park run» en el nombre, como el Brescia Park Run, se quedan.
...
- **«Mostrar más» ya sabe cuándo ha terminado:** en la lista de pruebas confirmadas sin edición futura, el botón repetía la última página sin fin y el total de arriba crecía con ella. Tampoco se salta pruebas que comparten fecha.
...
- **Pruebas repetidas con el mismo sitio:** la lista de posibles duplicados empareja dos pruebas que apuntan a la misma página del organizador, aunque cada calendario las haya archivado en un pueblo distinto.
...
- **Resultados de STGK:** las carreras cronometradas por STGK, en el norte de Alemania, ya importan tu resultado automáticamente. Pega el enlace de resultados de la prueba y la app encuentra la clasificación correcta entre las varias distancias del día.
...
- **Importar el resultado de parkrun desde la página impresa:** parkrun no permite la búsqueda automática, pero sí imprimir los resultados a PDF. Abre ese archivo en el editor del resultado y la app saca de ahí tu tiempo, tu puesto y el tamaño del campo. Se leen las dos versiones de la página, la compacta y la detallada. El archivo se lee en tu dispositivo y no se envía a ninguna parte.

### Corregido

- **Un nombre abreviado ya no coincide con la persona equivocada:** cuando alguien omite el apellido, los resultados muestran algo como «Jonas S». La app trataba esa inicial como un fragmento suelto, lo que la hacía coincidir con casi cualquier nombre. Ahora tiene que ser el principio de uno.
...
- **Importar el resultado del PDF oficial:** donde el cronometrador publica la clasificación pero bloquea la búsqueda, como en MaxFunSports, descarga el PDF y ábrelo en el editor del resultado. La app te encuentra en la tabla y rellena tiempo y puesto. El archivo se lee en tu dispositivo y no se envía a ninguna parte.
...
- **En una parkrun ya no aparece la invitación para vincularla al catálogo:** las parkrun no viven en ese catálogo, sus ocurrencias vienen del propio evento parkrun. En una carrera solo llamada "parkrun", sin vínculo con ninguna, la invitación sigue.
