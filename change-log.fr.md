...
- **Les souhaits suivent l'ordre où ils arrivent :** chacun donne la date de sa prochaine édition, dès que l'organisateur la publie et que la collecte la rapporte, ou le mois où la course a lieu d'habitude, et la liste suit cet ordre plutôt que l'alphabet.
...
- **Résultats STGK :** les courses chronométrées par STGK, dans le nord de l'Allemagne, importent désormais ton résultat automatiquement. Colle le lien des résultats de l'épreuve et l'application trouve le bon classement parmi les distances du jour.
...
- **Corriger un résultat à la main n'est plus masqué :** le bouton de nouvelle recherche recouvrait le crayon d'édition. Ils sont désormais côte à côte.
- **Enregistrer un résultat ne mène plus dans le vide :** le raccourci chronomètre menait à une page qui n'existe plus, et une course déjà courue n'offrait le formulaire qu'une fois marquée terminée.

### Modifié

- **La recherche automatique sur MaxFunSports est désactivée :** le site bloque toute lecture automatisée. Le temps s'enregistre à la main.
...
- **Les noms de courses ne portent plus l'édition :** « 33. Graz Marathon » devient « Graz Marathon », car la course est la même et le numéro change chaque année. Un nombre qui fait partie du nom (« 10 Marathon in 10 Tagen ») reste.
...
- **Les résultats que quelqu'un a déjà trouvés :** sur un événement sans lien de résultats, le catalogue propose la page de cette année, et l'utiliser est ton clic.
